...
const dispositivos_resolver_1 = require("./dispositivos.resolver");
...
exports.DispositivosModule = DispositivosModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [dispositivos_service_1.DispositivosService, dispositivos_resolver_1.DispositivosResolver],
    })
], DispositivosModule);
